...
class Test_BmiCalculatorCalculateBmi:
    ...
    def test_calculate_bmi_normal(self):
        assert calculate_bmi(1.75, 68) == 22.2

    def test_calculate_bmi_zero_height(self):
        assert calculate_bmi(0, 68) == None

    def test_calculate_bmi_negative_values(self):
        assert calculate_bmi(-1.75, 68) == -22.2

    def test_calculate_bmi_large_values(self):
        # Here we are using a very large height and weight values
        # We are assuming that the function should be able to handle these large values
        assert calculate_bmi(1000000, 1000000) is not None
