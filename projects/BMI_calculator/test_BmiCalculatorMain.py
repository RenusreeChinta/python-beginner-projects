...
class Test_BmiCalculatorMain:
    ...
    @pytest.mark.regression
    def test_reference_chart_display(self, mocker):
        mocker.patch('builtins.open', mocker.mock_open(read_data='bmi.csv'))
        mocker.patch('csv.reader')
        mocker.patch('tabulate.tabulate')
        reference_chart()
        csv.reader.assert_called_once()
        tabulate.tabulate.assert_called_once()
