...
class Test_BmiCalculatorMain:
    ...
    @pytest.mark.regression
    def test_main_nonnumerical_inputs(self):
        with mock.patch('builtins.input', side_effect=["abc", "xyz"]), \
             mock.patch('builtins.print') as mock_print:
            main()
        mock_print.assert_called_with("Invalid input. Please enter numerical values for height and weight.")

    @pytest.mark.regression
    @mock.patch('builtins.open', new_callable=mock.mock_open, read_data='bmi.csv')
    @mock.patch('tabulate.tabulate')
    def test_reference_chart_display(self, mock_tabulate, mock_open):
        reference_chart()
        mock_open.assert_called_once_with('bmi.csv')
