...
class Test_MainAddition:
    ...
    def test_addition_with_valid_input(self, monkeypatch):
        ...
        result = addition()
        assert result == 6, 'Test failed: Expected 6, got {}'.format(result)
    ...
    def test_addition_with_large_numbers(self, monkeypatch):
        monkeypatch.setattr('builtins.input', lambda _: '10000000000000000 20000000000000000')
        result = addition()
        assert result == 30000000000000000, 'Test failed: Expected 30000000000000000, got {}'.format(result)
