...
class Test_MainMultiplication:
    ...
    def test_multiplication_of_positive_integers(self, monkeypatch, input, expected):
    ...
    def test_multiplication_of_negative_integers(self, monkeypatch, input, expected):
        monkeypatch.setattr('builtins.input', lambda _: input)
        assert multiplication() == expected
    ...
    def test_multiplication_of_mixed_integers(self, monkeypatch, input, expected):
        monkeypatch.setattr('builtins.input', lambda _: input)
        assert multiplication() == expected
    ...
    def test_multiplication_with_zero(self, monkeypatch, input, expected):
        monkeypatch.setattr('builtins.input', lambda _: input)
        assert multiplication() == expected
