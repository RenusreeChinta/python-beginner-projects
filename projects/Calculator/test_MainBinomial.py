...
class Test_MainBinomial:
    ...
    def test_binomial_valid_inputs(self):
        ...
        # Act
        result = binomial(nums)

        # Assert
        assert result == expected_result, "The binomial coefficient calculation failed for valid inputs."
    ...
    def test_binomial_with_zero(self):
        ...
        # Assert
        assert result == expected_result, "The binomial coefficient calculation failed when one of the inputs is zero."
        ...
        # Assert
        assert result == 0, "The binomial coefficient calculation failed when n is zero and k is non-zero."
        ...
        # Assert
        assert result == 1, "The binomial coefficient calculation failed when both inputs are zero."
