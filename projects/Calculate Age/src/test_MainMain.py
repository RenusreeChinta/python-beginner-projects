...
class Test_MainMain:
    ...
    def test_valid_age_input(self):
        with patch('builtins.input', side_effect=['John', '25']):
            with patch('builtins.print') as mock_print:
                main()
            mock_print.assert_called_once_with("John's age is 25 years or 300 months or 9125 days")

    @pytest.mark.invalid
    def test_invalid_age_input(self):
        with patch('builtins.input', side_effect=['John', 'invalid', '25']):
            with patch('builtins.print') as mock_print:
                main()
            mock_print.assert_any_call("Please input a valid age.")

    @pytest.mark.leap_year
    def test_leap_year(self):
        with patch('builtins.input', side_effect=['John', '4']):
            with patch('builtins.print') as mock_print:
                main()
            mock_print.assert_called_once_with("John's age is 4 years or 48 months or 1461 days")
    ...
    def test_non_leap_year(self):
        with patch('builtins.input', side_effect=['John', '3']):
            with patch('builtins.print') as mock_print:
                main()
            mock_print.assert_called_once_with("John's age is 3 years or 36 months or 1095 days")
