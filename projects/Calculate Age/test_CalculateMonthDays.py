...
class Test_CalculateMonthDays:
    ...
    @pytest.mark.parametrize("month, leap_year, expected", [
        (1, True, 31),
        (3, False, 31),
        (5, True, 31),
        (7, False, 31),
    ...
    def test_month_days_for_31_days(self, month, leap_year, expected):
    ...
    def test_month_days_for_30_days(self, month, leap_year, expected):
        assert month_days(month, leap_year) == expected
